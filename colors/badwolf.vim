...
call s:HL('NonText',    'mediumgravel', 'bg')
call s:HL('SpecialKey', 'mediumgravel', 'bg')
...
call s:HL('StatusLine',   'dirtyblonde', 'deepergravel', 'none')
...
call s:HL('WildMenu', 'taffy', 'deepergravel',   'bold')
