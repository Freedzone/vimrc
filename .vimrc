...
#  Defines  #
#############
$VIMHOME = expand('$HOME/.vim')
$VIMCUSTOM = expand('$HOME/.vim/local') # host specific configs
$VIMBUNDLES = expand('$HOME/.vim/bundles') # bundles location
var is_win = has('win64') || has('win32') || has('win16')
var is_macos = has('osx') || has('osxdarwin')
g:bundles = []
...
def Lsource(filename: string)
    expfilename = expand(a:filename)
...
def Check_back_space()
    cols = col('.') - 1
    return !cols || getline('.')[cols - 1]  =~ '\s'
enddef

######################
#  Local pre-config  #
######################
Lsource($VIMCUSTOM .. '/pre.vimrc')

#########################
#  Plugins (vim-plug)  #
#########################
# install vim-plug if not found
if !is_win && empty(glob($VIMHOME . '/autoload/plug.vim'))
    !wget -P ~/.vim/autoload/
...
## Local plugins
Lsource($VIMCUSTOM . '/plugs.vim')

for bundle in g:bundles
    Lsource($VIMBUNDLES . '/' . bundle . '.plugs')
endfor
...
#######################
if is_win
    $VIMCONFIG = $VIMHOME # Windows uses 'vimfiles' as default, so change
...
# extensions
g:airline_extensions = ['ale', 'branch', 'bufferline', 'tabline', 'obsession']

g:airline#extensions#whitespace#enabled = 0

g:airline#extensions#tabline#enabled = 1
g:airline#extensions#tabline#show_splits = 1
g:airline#extensions#tabline#show_buffers = 1 # enable/disable displaying buffers with a single tab
g:airline#extensions#tabline#exclude_preview = 1
g:airline#extensions#tabline#fnamecollapse = 3
...
g:airline#extensions#bufferline#overwrite_variables = 0
...
## ALE
g:ale_python_pylint_executable = 'pylint'
g:ale_sign_error = ''
g:ale_sign_warning = ''
g:ale_sign_info = g:ale_sign_warning
g:ale_sign_style_error = ''
g:ale_sign_style_warning = g:ale_sign_style_error
# g:ale_sign_error = ''
# g:ale_sign_warning = ''
# g:ale_sign_info = ''
# g:ale_sign_style_error = ''
...
g:bufferline_modified = '*'
g:bufferline_rotate = 2
g:bufferline_fixed_index = 1 # always first
g:bufferline_pathshorten = 0

## coc.nvim
autocmd! CursorHold * silent call CocActionAsync('highlight')
g:coc_global_extensions = ['coc-sh', 'coc-pyright', 'coc-snippets']
...
g:UltiSnipsSnippetDirectories = ["UltiSnips", "my-snips"]
...
g:multi_cursor_prev_key = '<C-[>'

## vim-signify
g:signify_line_highlight = 0
...
#  Local post-config  #
#######################
Lsource($VIMCUSTOM . '/post.vimrc')

####################
#  Bundles config  #
####################
for bundle in g:bundles
    Lsource($VIMBUNDLES . '/' . bundle . '.vim')
endfor
